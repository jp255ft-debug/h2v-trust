"""Test script to debug the minting process - runs with backend context"""
...
from blockchain.web3_client import init_web3, get_contract, get_w3
...
if contract:
    ...
    try:
        ...
        print(f"process_receipt error: {type(e).__name__}: {e}")
        # Check raw logs
