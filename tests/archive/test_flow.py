...
print(f"   GHG limit: {compliance_result['ghg_limit']} kgCO2/kgH2")
print(f"   Water limit: {compliance_result['water_limit']} L/kgH2")
print(f"   GHG check: {compliance_result['ghg_check']}")
print(f"   Water check: {compliance_result['water_check']}")
print(f"   Energy source check: {compliance_result['energy_source_check']}")
...
print(f"   GHG check: {non_compliant_result['ghg_check']}")
print(f"   Energy source check: {non_compliant_result['energy_source_check']}")
