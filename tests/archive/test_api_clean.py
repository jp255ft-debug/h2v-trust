...
async def test_full_flow():
    print("Testing H2V-Trust flow with clean database...")
    print("=" * 60)
    
    # Create database session
    DATABASE_URL = "sqlite:///./h2v_trust_test.db"
        ...
        try:
            ...
            if compliance_result["is_compliant"]:
                ...
                try:
                    ...
                    print("5. Verifying certificate...")
                    verify_result = await cert_service.verify_on_chain(mint_result['certificate_id'])
                    print(f"   ✅ Certificate verified: {verify_result.get('is_valid', False)}")
